...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='startlife.conf'
CONFIGFOLDER='/root/.startlife'
COIN_DAEMON='startlifed'
COIN_CLI='startlife-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/startlifecoin/startlife/releases/download/v1.1/startlife-1.1.0-x86_64-pc-linux-gnu.zip'
COIN_NAME='startlife'
COIN_PORT=27018
RPC_PORT=27019
